"""Device info utilities for aircloudhome."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "Shirokuma AC (aircloudhome) Integration",
        manufacturer=manufacturer or "Shirokuma AC (aircloudhome) Integration",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('aircloudhome', 'entry_id_value')}
    """
