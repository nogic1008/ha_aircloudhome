...
from custom_components.aircloudhome.config_flow_handler.schemas import (
    get_reauth_schema,
    get_reconfigure_schema,
    get_user_schema,
)
from custom_components.aircloudhome.config_flow_handler.validators import validate_credentials
...
ERROR_MAP = {
    "AirCloudHomeApiClientAuthenticationError": "auth",
    "AirCloudHomeApiClientCommunicationError": "connection",
}


class AirCloudHomeConfigFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """
    Handle a config flow for aircloudhome.
    ...
    def async_get_options_flow(
        ...
        """
        from custom_components.aircloudhome.config_flow_handler.options_flow import (  # noqa: PLC0415
            AirCloudHomeOptionsFlow,
        )

        return AirCloudHomeOptionsFlow()
    ...
    async def async_step_user(
        ...
        return self.async_show_form(
            ...
            description_placeholders={
                "documentation_url": "https://github.com/nogic1008/ha_aircloudhome",
            },
        )
