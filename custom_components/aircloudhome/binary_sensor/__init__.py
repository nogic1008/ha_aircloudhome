"""Binary sensor platform for aircloudhome."""
...
from .connectivity import ENTITY_DESCRIPTIONS as CONNECTIVITY_DESCRIPTIONS, AirCloudHomeConnectivitySensor
from .filter import ENTITY_DESCRIPTIONS as FILTER_DESCRIPTIONS, AirCloudHomeFilterSensor
...
async def async_setup_entry(
    ...
    connectivity_entities = [
        AirCloudHomeConnectivitySensor(
