"""Target humidity number for aircloudhome."""

from __future__ import annotations

from typing import TYPE_CHECKING

from custom_components.aircloudhome.api import AirCloudHomeApiClientError
...
class AirCloudHomeHumidityNumber(NumberEntity, AirCloudHomeEntity):
