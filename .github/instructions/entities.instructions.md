...
- **`entity/`** - Base entity classes (inherit `AirCloudHomeEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, AirCloudHomeEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import AirCloudHomeEntity`
