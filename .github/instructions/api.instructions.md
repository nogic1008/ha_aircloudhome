...
- `AirCloudHomeApiClientError` (Base)
- `AirCloudHomeApiClientCommunicationError` (Network, timeout, HTTP errors)
- `AirCloudHomeApiClientAuthenticationError` (401, 403, invalid credentials)
