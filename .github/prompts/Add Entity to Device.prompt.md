...
- Inherit from `AirCloudHomeEntity` and platform base class
...
- Entity: `custom_components/aircloudhome/[platform]/[entity_name].py`
- Platform: `custom_components/aircloudhome/[platform]/__init__.py`
