...
**File:** `custom_components/aircloudhome/services.yaml`
...
Create `custom_components/aircloudhome/service_actions/[action_name].py`:

```python
"""[Action name] service action for Shirokuma AC (aircloudhome) Integration."""
...
**File:** `custom_components/aircloudhome/__init__.py`
...
**File:** `custom_components/aircloudhome/const.py`
...
3. Find service action: `aircloudhome.[action_name]`
...
- **Domain:** `aircloudhome`
- **Service actions directory:** `custom_components/aircloudhome/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/aircloudhome/services.yaml` (legacy filename)
- **Icons:** `custom_components/aircloudhome/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/aircloudhome/translations/*.json` under `services` key (legacy)
