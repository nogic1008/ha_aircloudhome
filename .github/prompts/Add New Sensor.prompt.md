...
- Create new sensor file in `custom_components/aircloudhome/sensor/`
- Inherit from `AirCloudHomeEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Shirokuma AC (aircloudhome) Integration."""
...
class AirCloudHome[SensorName]Sensor(
    AirCloudHomeEntity,
    SensorEntity,
):
...
- Entity: `custom_components/aircloudhome/sensor/[sensor_name].py`
- Platform: `custom_components/aircloudhome/sensor/__init__.py`
- Translations: `custom_components/aircloudhome/translations/*.json`
