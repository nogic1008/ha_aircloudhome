...
- **Main code:** `custom_components/aircloudhome/`
...
- `entity/` — Base entity class (`AirCloudHomeEntity`)
...
- Entity MRO: `(PlatformEntity, AirCloudHomeEntity)` — order matters
...
- Debug level: `custom_components.aircloudhome: debug` in `config/configuration.yaml`
